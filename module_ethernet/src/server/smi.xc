...
void smi_init(clock clk_smi, out port ?p_mii_resetn, chanend ?c_mii_reset, smi_interface_t &smi)
{
...
// Reset the MII PHY
void smi_reset( chanend ?c_mii_reset, out port ?p_mii_resetn, smi_interface_t &smi)
{
