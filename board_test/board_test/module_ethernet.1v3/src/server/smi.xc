...
// Phy
#define PHY_RST_N_EN  0
#define PHY_RST_N_DIS
...
void smi_init(clock clk_mii_ref, clock clk_smi, chanend smi_rst_n, smi_interface_t &smi)
{
...
void smi_deinit(clock clk_mii_ref, clock clk_smi, smi_interface_t &smi)
{
  // Set the clock rate rate
  stop_clock (clk_smi);
  set_clock_off(clk_smi);
...
// Reset the MII PHY
void smi_reset(chanend smi_rst_n, smi_interface_t &smi)
{
